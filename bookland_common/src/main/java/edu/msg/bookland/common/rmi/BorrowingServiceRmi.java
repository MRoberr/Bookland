...
public interface BorrowingServiceRmi extends Remote {
	 ...
	 */
	public List<Borrowing> getBorrowByUserUUID(String uuid) throws RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void returnPublication(Borrowing borrow) throws RemoteException;
	 ...
	 * @throws RemoteException
	 */
	public void borrowPublication(Borrowing borrow) throws RemoteException;
}
