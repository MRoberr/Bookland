...
CREATE TABLE `library`.`library_users` (
  ...
  `name` VARCHAR(45) NOT NULL UNIQUE collate latin1_general_cs,
  `email` VARCHAR(45) NOT NULL UNIQUE,
  `user_type` enum('ADMIN','READER','SUPER'),
  `loyalty_index` INT(2),
   `password` VARCHAR(80),
  PRIMARY KEY (`uuid`),
...
INSERT INTO `library`.`library_users` (`uuid`, `name`,  `email`,`user_type`, `loyalty_index`, `password`) VALUES ('14666', 'Zolti', ' zolti@msg.com','SUPER', '10', '���N�@�c�0�GW��d>');
